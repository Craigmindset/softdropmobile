    ...
    <>
      ...
      >
        <View style={styles.profileSection}>
          <Image
            source={require("../../assets/images/craig.jpg")}
            style={styles.avatar}
          />
          <View>
            <Text style={styles.userName}>Hello, Craig</Text>
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={{ fontSize: 8, marginTop: 0 }}>Pair a Carrier</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={{ fontSize: 8, marginTop: 0 }}>Receive an Item</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.gridItem,
          ...
          >
            ...
            <Text style={{ fontSize: 8, marginTop: 0 }}>Schdule a Pickup</Text>
          </TouchableOpacity>
        </View>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: 8, marginTop: 0 }}>locked savings</Text>
            </TouchableOpacity>
          </View>
          {/* Additional Actions */}
          <View
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: 8, marginTop: 0 }}>Flight Booking</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={{ fontSize: 8, marginTop: 0 }}>Global Connect</Text>
            </TouchableOpacity>
          </View>
