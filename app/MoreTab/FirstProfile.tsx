...
const FirstProfile = () => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      // Set profile updated flag so Home can unblock navigation
      await AsyncStorage.setItem(`profileUpdated:${userId}`, "1");
      Alert.alert("Profile updated!");
      router.replace("/(tabs)/Home"); // Redirect to Home after update
    } catch (e) {
    ...
    <>
      ...
      >
        ...
        <View style={styles.formGroup}>
          <Text style={styles.label}>First1 Name</Text>
